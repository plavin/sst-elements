...
#ifndef _H_SST_MIRANDA_DIST_GEN
#define _H_SST_MIRANDA_DIST_GEN
...
class DistGenerator : public RequestGenerator {

public:
	DistGenerator( ComponentId_t id, Params& params );
	DistGenerator( Component* owner, Params& params );
	...
	SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        ...
        SST_ELI_DOCUMENT_PARAMS(
            ...
            { "lambda",           "Sets the lambda for the exponential distribution", "0.2" },
            { "count",            "Number of requests of each distribtion type", "1024" },
...
private:
	...
	uint64_t seed_b;
	SSTRandom* rng;
	SSTRandomDistribution* rng_expon;
	Output*  out;
	bool issueOpFences;
